...
Next.js を `output: "export"` で使用する際、画像最適化を助けてくれるライブラリ 2 つを比較しました。

| 作者     | 名前                        | 最適化対象の検出      | Next.js v16 + turbopack |
| -------- | --------------------------- | --------------------- | :---------------------: |
| Niels-IO | next-image-export-optimizer | ./out ファイル解析    |          対応           |
| dc7290   | next-export-optimize-images | next/image 参照を解析 |         非対応          |
...
と言った工夫を併用し、より効率良く適切なサイズの画像を配布する技術が用いられます。これを指して「画像最適化」と呼んでいます。
